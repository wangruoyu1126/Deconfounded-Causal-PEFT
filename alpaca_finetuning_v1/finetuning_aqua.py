...
# PROMPT_DICT = {
#     "prompt": (
#         "Below is a multiple choice question with a set of options."
#         "Please response with the correct answer.\n\n"
#         "### Question:\n{question}\n\n### options:\n{options}\n\n### Response:"
#     )
# }
class InstructionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ann = self.ann[index]
        ann["options"] = "; ".join(ann["options"])

        # prompt = PROMPT_DICT["prompt"].format_map(ann)
        prompt = ann["question"] + " Options:" + ann["options"] + "."
        example = prompt + ann["correct"]
...
def get_args_parser():
    ...
    parser.add_argument("--adapter_layer", type=int, default=20, metavar="LENGTH", help="the number of adapter layer")
