...
from llama import ModelArgs, Tokenizer, Transformer, TransformerContra, TransformerContraCase2
...
def Llama7B_adapter(args, **kwargs):
    ...
    # model_llama_adapter = TransformerContra(model_args)
    model_llama_adapter = TransformerContraCase2(model_args)
    torch.set_default_tensor_type(torch.FloatTensor)
    model_llama_adapter.load_state_dict(checkpoint, strict=False)

    # for llama, only train adapter_query
    ...
    # for last #adapter_layer, train gate
