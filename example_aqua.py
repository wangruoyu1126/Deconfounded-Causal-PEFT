...
def load(
    ...
    #     print("==== checkpoint", key, checkpoint[key].shape)
    # for key in adapter_checkpoint.keys():
    #     print("==== adapter_checkpoint", key, adapter_checkpoint[key].shape)
...
def main(
    ...
    while len(instructs) > 0:
        # prompts = [PROMPT_DICT["prompt"].format_map({"instruction": x}) for x in instructs]
        prompts = instructs
